...
VALUES
(100,'Grønne frøer', 'Her på det østligste punkt kan man se mange dyr. Mest højlydt er grøn frø, men de er så hurtige til at smutte væk, at de sjældent ses. I denne måned er det dog muligt da det er grøn frø yngletid og de derfor er mere fremme',
 25, '2021-05-06', '2021-06-06', 'https://www.christiansoe.dk/wp-content/uploads/2018/11/animals.jpg', '/test/path/sound', 20),
(200,'Christiansø hest', 'Kom ind i hestehytten og hils på de søde heste her på Christiansø. Her kan du få lov at fodre og ae det store heste, og mellem kl. 10-15, er der mulighed for de mindste at ride i ringe.',
 30, '2021-05-01', '2021-08-20', 'https://cdn.pixabay.com/photo/2017/04/02/19/12/horse-2196656__480.jpg', '/test/path/sound', 20),
(300,'Kunst og kultur', 'I 2018 blev Christiansø Kunst og Kulturråd oprettet.
...
(400,'Store tårn - store is', 'Så skete det. Den omvandrende isbod har nået sit stop ved store tårn! Kom og få øens billigste og største is! Du kan også få en islatté, sodavand eller kaffe til din dejlige vandre tur på Christiansø',
...
(600,'Edderfugle', 'Lige nu har Edderfuglenes yngletid her på Christiansø. Edderfuglene lever mest af blåmuslinger. Kort efter edderfugleællingerne er klækket, svømmer de i småflokke sammen med hunnerne til Bornholm, hvor der er mere mad til ungerne i form af tanglopper og småmuslinger.',
 22, '2021-04-01', '2021-09-02', 'https://www.christiansoe.dk/wp-content/uploads/2018/12/aabo-2-1024x680.jpg', '/test/path/sound', 16),
(700,'Ynglefuglene på Christiansø', 'De fleste af ynglefuglene er hav- og kystfugle, fx alk, lomvie, sølvmåge og edderfugl. Alk og lomvie er ægte havfugle, der kun kommer på land i yngletiden. Normalt holder de kun til på ',
 23, '2021-05-06', '2021-09-02', 'https://www.christiansoe.dk/wp-content/uploads/2018/11/fugl7457.jpg', '/test/path/sound', 16),
(800,'Øl-smagning', 'Kom til ølsmagning i pak huset og smag på Christiansø. Ølet er levet med de fineste ingredienser Øen har at byde på',
...
(900,'Sæler', 'Her finder du Danmarks frækkeste sæler', 20, '2021-01-06', '2021-12-02', 'https://naturstyrelsen.dk/media/290839/sael-der-vinker.jpg', '/test/path/sound', 1),
...
(1100,'Kanon med kanoner', 'Her finder du en række af Christiansøs forsvar, i form af gode gammeldavs kanoner',
...
(1200,'Spøgelser og andre myter', 'Det spøger på christiansø, kom og hør om christiansøs helt eget spøgelse ved farhansylv',
...
(1300,'Vinsmagning i Jesus tegn', 'Af jord er du kommet og af jord skal du blive. Eller, det bliver du i hvert fald efter du har fået en lille en her i guds hus. Vel mødt!',
 20, '2021-05-06', '2021-06-02', 'https://edge.churchdesk.com/blog-52544/span5_16-9/public/o/322/brod.og.vin.jpg', '/test/path/sound', 6),
(1400,'Bastionen over alle bastioner', 'Her ser du et stykke af christiansøs historie. Kongens bastion er den største og vigtigste af alle fortets bastioner.',
...
(1500,'Biavling ved havnen', 'Christiansøs helt egen biavler, viser dig hvordan man fremavler de bedste og mest arbejdsomme bier. Mulighed for at prøvesmage den lækre naturlige honning, fra ægte nordiske bier.',
...
(1600,'Hotel Ballonen', 'Denne seværdighed er både historisk men også praktisk. Det forhenværende statsfængsel er blevet omtryllet til et vaskeægte lågsus hotel.',
...
(1700,'Havmåger', 'Om sommeren vækker livet omkring christiansø sig. Store og talrige måger ses ved badebroen.',
